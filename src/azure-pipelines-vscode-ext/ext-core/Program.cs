...
public class MyClass {
    ...
    private static IEnumerable<CompletionItem> AddSuggestion(TemplateSchema schema, AutoCompleteEntry bestMatch, Definition? def, DefinitionType[]? allowed)
    {
