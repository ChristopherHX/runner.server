...
namespace Runner.Server.Controllers
{
    ...
    public class CacheControllerV2 : VssControllerBase{
        ...
        public async Task<Github.Actions.Results.Api.V1.CreateCacheEntryResponse> CreateCacheEntry([FromBody, Protobuf] Github.Actions.Results.Api.V1.CreateCacheEntryRequest body) {
            ...
            return new Github.Actions.Results.Api.V1.CreateCacheEntryResponse
            {
                Ok = true,
        ...
        public Github.Actions.Results.Api.V1.FinalizeCacheEntryUploadResponse FinalizeCacheEntryUpload([FromBody, Protobuf] Github.Actions.Results.Api.V1.FinalizeCacheEntryUploadRequest body) {
            var record = _context.Caches.First(c => c.Key == body.Key && c.Version == body.Version);
            return new Github.Actions.Results.Api.V1.FinalizeCacheEntryUploadResponse
            {
                Ok = true,
                EntryId = record.Id
            };
        ...
        public Github.Actions.Results.Api.V1.GetCacheEntryDownloadURLResponse GetCacheEntryDownloadURL([FromBody, Protobuf] Github.Actions.Results.Api.V1.GetCacheEntryDownloadURLRequest body) {
            ...
            foreach(var cref in reference != defaultRef ? new [] { reference, defaultRef } : new [] { reference }) {
                foreach (var item in a) {
                    ...
                    if(record != null) {
                        return new Github.Actions.Results.Api.V1.GetCacheEntryDownloadURLResponse
                        {
                            Ok = true,
            ...
            return new Github.Actions.Results.Api.V1.GetCacheEntryDownloadURLResponse { Ok = false };
        }
    }
}
