namespace GitHub.DistributedTask.Expressions2.Sdk.Functions.v1 {
    public static class Extensions {
        public static Legacy.EvaluationResult ToLegacy(EvaluationContext context, EvaluationResult node) {
            ...
            if(node.Kind == ValueKind.String && node.Raw is Runner.Server.Azure.Devops.VersionWrapper wrapper) {
                return new Legacy.EvaluationResult(context, 0, wrapper.Version, ValueKind.Version, wrapper.Version, true);
            }
